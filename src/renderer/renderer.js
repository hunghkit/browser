...
class BrowserController {
  ...
  initializeElements() {
    ...
    this.autoRefreshRotateProxy = document.getElementById('auto-refresh-rotate-proxy');
  ...
  async openAutoRefreshModal() {
    ...
    try {
      ...
      this.autoRefreshRotateProxy.checked = settings.rotateProxy || false;
  ...
  async saveAutoRefreshSettings() {
    ...
    const rotateProxy = this.autoRefreshRotateProxy.checked;
